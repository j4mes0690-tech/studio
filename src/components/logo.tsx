 ...
 * Features a stylized orange hard hat icon.
      ...
      <div className={cn(
        ...
        {src ? (
          ...
          >
            <defs>
              <style>
                {`.helmet { fill: none; stroke: #f26522; stroke-width: 35; stroke-linecap: round; stroke-linejoin: round; }`}
              </style>
            </defs>

            {/* Hard hat - Brand Orange #f26522 */}
            {/* Centered vertically within the viewbox */}
