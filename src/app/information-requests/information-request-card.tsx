...
import { Camera, Users, MessageSquareReply, CalendarClock, XCircle, RefreshCw, Trash2, Maximize2, Link as LinkIcon, ExternalLink, FileText, Download, CheckCircle2, Loader2, Send, EyeOff, Bell } from 'lucide-react';
  ...
  return (
    <>
      <Card className={cn(
          ...
          isAttentionRequired && "border-primary border-2 shadow-primary/10 bg-primary/[0.02] ring-1 ring-primary animate-in fade-in zoom-in duration-300"
      )}>
        <CardHeader>
