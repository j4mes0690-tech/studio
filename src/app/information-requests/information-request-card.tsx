...
import { Camera, Users, MessageSquareReply, CalendarClock, XCircle, RefreshCw, Trash2, Maximize2 } from 'lucide-react';
                                  ...
                                  <div className={cn(
                                      ...
                                      {msg.photos && msg.photos.length > 0 && (
                                        <div className="grid grid-cols-2 gap-2 mt-3">
                                          {msg.photos.map((p, i) => (
                                            <div key={i} className="relative aspect-video rounded-lg overflow-hidden border bg-background cursor-pointer hover:opacity-90 transition-opacity group" onClick={() => setViewingPhoto(p)}>
                                              <Image src={p.url} alt="Discussion Context" fill className="object-cover" />
